...
#源文件
urllistfile = './config/sublist_free'
#输出订阅文件位置
outputUrlSub_path = './sub/free/goodfree/goodfree'
outputBase64Sub_path =  './sub/free/goodfree/goodfree64'
outputClashSub_path = './sub/free/goodfree/goodfreeClash.yml' 
